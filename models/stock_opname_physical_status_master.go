...
// perilakunya ditentukan lewat 3 flag di bawah (tidak ada "update" sengaja,
...
type StockOpnamePhysicalStatusMaster struct {
	...
	// RequiresNotApplicableCondition: kalau true, condition WAJIB salah satu
	// yang ditandai IsNotApplicableValue (dulu "MISSING"/"BORROWED" ->
	// NOT_APPLICABLE). Kalau false, condition JUSTRU DILARANG pakai nilai
	// yang ditandai IsNotApplicableValue (dulu "EXISTS").
	RequiresNotApplicableCondition bool `gorm:"not null;default:false" json:"requires_not_applicable_condition"`
